  ...
  return (
    ...
    <div className='flex xl:flex-row flex-col m-auto bg-white ' style={{maxWidth: '1500px', borderRadius: '32px'}}>
      ...
      <div className='w-full p-5 flex-1 xl:min-w-620'>
        ...
        <input 
        type="text"
        className='flex flex-1 border-gray-100 outline-none border-2 p-2 rounded-2xl focus:border-gray-400'
    ...
    {pins.length ? (
      ...
      // pinDetail?.category ? (  // Check if the current pin belongs to a category
